...
def test():
	for i in xrange(10):
		Request('192.168.87.4', 8588, 5, 'FFFF012345678900000118EBK000101001UU00ABCDEFGHIJKLMNOPQRSTUVWXYZ000000000020010200210004600100220018110000001000101836').start()
